...
export const WobbleButton:FC<Props> = ({className,children,title,textStyle,type}) => {
  ...
  return (
    <div>
          <motion.div
            className="rounded-full bg-[#4169E1] overflow-hidden relative"
            variants={buttonParentVariants}
            whileHover="hover"
          >
            <motion.span
              className="absolute w-full h-full bg-blue-700 -left-full block rounded-full"
            ...
            <motion.span
              className="absolute w-full h-full bg-blue-500 -left-full block rounded-full"
