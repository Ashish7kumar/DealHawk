...
const Searchbar = () => {
  ...
  return (
    <form className="flex px-4 flex-wrap gap-4 mt-12" onSubmit={handleSubmit}>
      ...
      <button
        type="submit"
        className="bg-[#4169E1]  rounded-3xl shadow-xs px-6 py-3 text-white text-base font-semibold hover:opacity-90 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-40"
